...
class UserServiceTest {
    ...
    @Test
    void testCreateUser_ValidUserRequest_CreatesUserEntity() {
    ...
    @Test
    void testUpdateUser_ValidUpdateUserRequest_CreatesUpdateUserResponse() {
    ...
    @Test
    void testFindUsersInBirthdateRange_ValidDateRange_ReturnsFoundUsersResponse() {
        ...
        assertThat(expectedResponse.count()).isEqualTo(expectedUsers.size());
        assertThat(expectedResponse.users()).isEqualTo(expectedUsers);
    }
}
